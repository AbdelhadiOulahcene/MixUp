...
function testFunction(){
  ...
  if ( scl > 335 && !Triggered ){
    console.log(document.querySelector('.gridContainer').style);
    document.querySelector('.gridContainer').style.animation="cnt both 1s";
    Triggered = true;
  }
}*/
var Triggered = false;
...
function Anim(){
    const scl = document.scrollingElement.scrollTop;
    if( scl>234 && !Triggered ){
        document.getElementById("test").style.animationName="Animation_Nav1";        
        Triggered = true;
    } else if ( scl <234 && Triggered ){
        document.getElementById("test").style.animationName="Animation_Nav-1";        
        Triggered = false;
    }
}
